...
CREATE DATABASE [$(DatabaseName)]
    ON 
    PRIMARY(NAME = [Employee], FILENAME = '$(DefaultDataPath)$(DatabaseName).mdf', SIZE = 2304 KB, FILEGROWTH = 1024 KB)
    LOG ON (NAME = [Employee_log], FILENAME = '$(DefaultLogPath)$(DatabaseName)_log.ldf', SIZE = 1024 KB, MAXSIZE = 2097152 MB, FILEGROWTH = 10 %) COLLATE SQL_Latin1_General_CP1250_CI_AS
GO
...
GO
PRINT N'Creating Id_PrimaryKeyConstraint...';


GO
ALTER TABLE [dbo].[Employee]
    ADD CONSTRAINT [Id_PrimaryKeyConstraint] PRIMARY KEY CLUSTERED ([Id] ASC) WITH (ALLOW_PAGE_LOCKS = ON, ALLOW_ROW_LOCKS = ON, PAD_INDEX = OFF, IGNORE_DUP_KEY = OFF, STATISTICS_NORECOMPUTE = OFF);
...
GO
PRINT N'Creating PrimaryKeyConstraint...';


GO
ALTER TABLE [dbo].[JobTitle]
    ADD CONSTRAINT [PrimaryKeyConstraint] PRIMARY KEY CLUSTERED ([Id] ASC) WITH (ALLOW_PAGE_LOCKS = ON, ALLOW_ROW_LOCKS = ON, PAD_INDEX = OFF, IGNORE_DUP_KEY = OFF, STATISTICS_NORECOMPUTE = OFF);
...
GO
PRINT N'Creating JobTitle.ForeignKeyConstraint...';
...
GO
ALTER TABLE [dbo].[Employee] WITH CHECK CHECK CONSTRAINT [JobTitle.ForeignKeyConstraint];
